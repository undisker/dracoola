...
UNITS="-Fu$ROOTDIR/Source -Fu$ROOTDIR/Source/JpegTurbo -Fu$ROOTDIR/Source/ZLib -Fu$ROOTDIR/Extensions -Fu$DEMOPATH/Common"

DEMOCOUNT=2

buildDemo "SDLDemo/SDLDemo.lpr"
buildDemo "OpenGLDemo/OpenGLDemo.lpr" 
